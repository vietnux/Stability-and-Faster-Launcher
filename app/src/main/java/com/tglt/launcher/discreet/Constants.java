...
public abstract class Constants
{
	...
	public static final String FILE_QUICK_BAR = "quickbar.txt" ;
    ...
    public static final int COLUMNS_QUICK_PORTRAIT = 5 ;
    public static final int COLUMNS_QUICK_LANDSCAPE = 6 ;
	...
	public static int LIMIT_APP = 20;
	public static final String ACTION_TOGGLE_FREEFORM_MODE = "com.tglt.launcher.discreet.TOGGLE_FREEFORM_MODE";
	public static final String ACTION_SHOW_HIDE_LAUNCHER = "com.tglt.launcher.discreet.SHOW_HIDE_TASKBAR";
	public static final String ACTION_QUIT = "com.tglt.launcher.discreet.QUIT";
